...
video_list = [
    ...
    (-1, False,     '20181006_175105.mp4', (1920, 1080), 0.8),  # 1  <= Goeie data (Golfbaan) (Medium)
    (-1, False,     '20181006_175204.mp4', (1920, 1080), 0.5),  # 2  <= Goeie data (Golfbaan) (Lank)
    (-1, False,     '20181006_175546.mp4', (1920, 1080), 0.8),  # 3  <= Goeie data (Golfbaan) (Kort) (Hill parking)
    (-1, False,     '20181006_175653.mp4', (1920, 1080), 0.5),  # 4  <= Goeie data (Golfbaan) (Lank)
    ...
    (-1, False,     '20181006_180654.mp4', (1920, 1080), 0.8),  # 7  <= Goeie data (Golfbaan) (Medium)
    ...
    (-1, False, 'StrandGolfbaan_a_02.mp4', (848, 480), 1.3),    # 18 <= Medium (Brug bo)
    (-1, False, 'StrandGolfbaan_a_03.mp4', (848, 480), 1.3),    # 19 <= Medium (Brug onder)
